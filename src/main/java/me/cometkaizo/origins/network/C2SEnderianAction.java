...
public class C2SEnderianAction {

    public static final Logger LOGGER = LogManager.getLogger();
    private final EnderianOriginType.Action action;

    public C2SEnderianAction(EnderianOriginType.Action action) {
        this.action = action;
    }

    public C2SEnderianAction(PacketBuffer packetBuffer) {
        this.action = packetBuffer.readEnumValue(EnderianOriginType.Action.class);
    }
